...
export type Music = {
  ...
  extraArtistIDs: string;   // The IDs of the artists that contributed to the song, separated with .
  externalLink  : string;   // The external link to the song (NOT the GD download link)
  newTag        : boolean;  // Whether there's a yellow NEW icon next to the song
